...
$(document).ready(function () {
    ...
    function judgement() {
      ...
      let result = $('#declaration').append(`<label id="alert-indicate" class="alert alert-info">あなたの成績は${achievement}です。${pass_or_failure}です。</label>`);
    };    
    ...
    $('#btn-declaration').click(function () {
        $('#declaration #alert-indicate').remove();
        judgement()
    });
  });
